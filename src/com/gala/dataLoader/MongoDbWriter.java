...
public class MongoDbWriter {
	...
	public MongoDbWriter(final MongoClient client_, final String dbName_, final String collName_){
		_client = client_;
		_dbName = dbName_;
		_collectionName = collName_;
	...
	public boolean writeEntry(final HashMap<String,Object> dataEntry_){
		
		if (dataEntry_ != null) {
			try {
				BasicDBObject dbEntry = convertEntryToDbObject(dataEntry_);
				_collection.insert(dbEntry);
			} catch (Exception e) {
